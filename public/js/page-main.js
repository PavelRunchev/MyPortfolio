...
//*
//guide to JS
document.querySelector('.fa-js-square').addEventListener('click', function() {
...
//guide to SASS
document.querySelector('.fa-sass').addEventListener('click', function() {
...
//guide to HTML5
document.querySelector('.fa-html5').addEventListener('click', function() {
  openPage('https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5', false);
});
//guide to CSS3
document.querySelector('.fa-css3-alt').addEventListener('click', function() {
